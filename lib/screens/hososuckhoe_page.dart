...
class HoSoSucKhoePage extends StatelessWidget {
  const HoSoSucKhoePage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Hồ sơ người bệnh"), centerTitle: true),
      body: Padding(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildButton("THÔNG TIN HỒ SƠ"),
          _buildButton("XEM HỒ SƠ SỨC KHOẺ"),
          _buildButton("XEM KẾT QUẢ CẬN LÂM SÀNG"),
          _buildButton("XEM HÌNH ẢNH CHỤP"),
          _buildButton("XEM PHIẾU ĐĂNG KÝ KHÁM"),
        ],
      ),
    );
  }
